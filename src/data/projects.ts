...
export const projects: Project[] = [
  {
    ...
    images: [
      "img/green-wheel/1.png",
      "img/green-wheel/2.png",
      "img/green-wheel/3.png",
      "img/green-wheel/4.png",
      "img/green-wheel/5.png",
      "img/green-wheel/6.png",
      "img/green-wheel/7.png",
    ],
    codeSnippet:
  ...
  },
  {
    ...
    images: [
      "img/ecom-orchid/pic_1.png",
      "img/ecom-orchid/pic_2.png",
      "img/ecom-orchid/pic_3.png",
      "img/ecom-orchid/pic_4.png",
      "img/ecom-orchid/pic_5.png",
    ],
    codeSnippet:
